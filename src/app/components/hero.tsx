...
export function Hero({ accent }: { accent: string }) {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-8">
            ...
            >
              Alex
              <br />
              Mercer<span style={{ color: accent }}>.</span>
            </h1>
            ...
            >
              Building reliable systems at scale. Speaker, consultant, and thinker —
              turning complex problems into simple, brutal, effective code.
            </p>
